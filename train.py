...
from networks.siamese_network_2.DataGenerator import DataGenerator
from networks.siamese_network_2.SiameseModel import SiameseModel
import os
...
training_similar_path = './train_npy/similar'
training_different_path = './train_npy/different'
...
val_similar_path = './val_npy/similar'
val_different_path = './val_npy/different'
